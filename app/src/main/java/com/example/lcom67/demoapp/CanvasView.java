...
public class CanvasView extends View {
    ...
    private int paintStrokeColor = R.color.colorPrimary;
    private int paintFillColor = R.color.colorPrimary;
    private float paintStrokeWidth = 9F;
...
//             paint.setShadowLayer(this.blur, 0F, 0F, this.baseColor);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.bitmap != null) {
            ...
            alphaChannel.setAlpha(150);


            canvas.drawBitmap(this.bitmap, this.getMatrix(), alphaChannel);
...
//        }
    ...
    public void setLayerType(int layerType, Paint paint) {
        super.setLayerType(View.LAYER_TYPE_SOFTWARE, createPaint());
    }
}